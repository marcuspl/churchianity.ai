# Manuscript TOC — Merged Draft (v1)

*Merged from three independent AI tracks (Claude Opus 4.6, Gemini 3.1 Pro, GPT 5.2) under human editorial direction.*
...
- Appendix D: Knowledge Graphs (companion file: `appendix-d-knowledge-graphs.md`)
