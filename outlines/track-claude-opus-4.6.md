...
3.4.D.1 All three affirm the Trinity, the Incarnation, the Resurrection.\
3.4.D.2 All three practice baptism and some form of eucharistic meal.\
3.4.D.3 All three read the same Scriptures (with variation at the margins).\
3.4.D.4 All three have produced saints, scholars, martyrs, and mystics.\
3.4.D.5 The disagreements are real. The shared ground is larger.
...
3.5.C.1 Can a tradition recover density it has lost? What would that look like concretely?
...
4.1.2.F Read a Protestant biblical commentary — the exegetical tradition is enormous and rigorous.\
4.1.2.G Visit a church plant or mission church — see what missionary zeal looks like on the ground.\
4.1.2.H Engage with the social teaching tradition of Catholicism on justice and poverty.
...
4.1.3.F Attend an Evangelical Bible study — experience what deep personal engagement with Scripture looks like in community.\
4.1.3.G Explore hesychasm and the Jesus Prayer — the Eastern contemplative tradition that parallels but differs from Ignatian spirituality.\
4.1.3.H Read the Reformers charitably — not as prosecutors but as fellow Christians who saw real problems and proposed real (if imperfect) solutions.
...
4.5.2 The Joint Catholic-Orthodox Commission (ongoing since 1980).\
4.5.3 The Lutheran-Catholic Joint Declaration on Justification (1999) — the core Reformation dispute, formally addressed.\
4.5.4 The Balamand Declaration (1993) — rejecting "uniatism" as a method of reunion.\
4.5.5 The Chambésy agreements on Oriental Orthodox Christology — resolving a 1,500-year dispute.\
4.5.6 What these dialogues show: the theological distance is shrinking, even if institutional reunion remains distant.\
4.5.7 The laity mostly don't know any of this. They should.
...
5.4.1 Three independent agents develop the same outline in parallel.\
5.4.2 Convergence = high confidence. Divergence = signal for closer examination.\
5.4.3 The editorial merge is where human judgment enters.\
5.4.4 This method is itself an expression of the conciliar principle: multiple voices, testing each other, arriving at something none would have reached alone.
