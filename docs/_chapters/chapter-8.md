...
One clarification: these on-ramps are for you as an individual. Introducing another tradition's practices into your congregation — icons in a Baptist church, tongues in a Presbyterian service — is a different act with different stakes, and it is not what this chapter recommends.

A caveat: if your instinct is telling you that something is unsafe — not merely unfamiliar, but genuinely coercive or manipulative — trust it. The distinction between discomfort and danger is real, and this book honors both.
...
And if you are here because your tradition hurt you — because the walls were not just limiting but wounding — this chapter is not asking you to go back. Exploration from a place of injury requires different care than exploration from a place of curiosity. Find safe guides. Move slowly. The map is still useful; the starting point is different.
...
[^1]: Phyllis Tickle, *The Divine Hours*, 3 vols. (New York: Doubleday, 2000–2001). An accessible fixed-hour prayer book compiled from the *Book of Common Prayer*, the Benedictine *Liturgy of the Hours*, and other sources.
